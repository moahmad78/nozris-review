...
const newAuthSecret = "d0e9c8b7a6f5e4d2c1b0a9f8e7d6c5b4a3f2e1d0c9b8a7f6e5d4c3b2a1f0e9d8"; // Generated random hex

let content = '';
if (fs.existsSync(envPath)) {
    content = fs.readFileSync(envPath, 'utf-8');
    console.log("Reading existing .env...");
} else {
...
// Update or Add
envMap['DATABASE_URL'] = `"${newDbUrl}"`; // Wrap in quotes to be safe
envMap['AUTH_SECRET'] = `"${newAuthSecret}"`;
// User mentioned NEXTAUTH_SECRET too to sync
